...
var _user$project$Main$tile = function (string) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Main$newBoard = function () {
	var tiles = A2(
		...
		return A4(
			...
			F3(
				function (id, name, tiles) {
					return A4(_user$project$Main$Player, id, name, tiles, _user$project$Main$newBoard);
				}),
			ids,
			playerNames,
			playerTiles);
...
var _user$project$Main$init = function (_p2) {
	...
	var shuffledTiles = A2(
		_elm_lang$core$List$map,
		function (letter) {
			return _user$project$Main$tile(letter);
		},
		shuffledLetters);

...
var _user$project$Main$playerUI = function (player) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id(playerId)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('player-title')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('player-board')
					]),
				playerRows),
				A2(
				_elm_lang$html$Html$div,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('#players')
					]),
				A2(_elm_lang$core$List$map, _user$project$Main$playerUI, model.players))
			]));
};
...
var _user$project$Main$letterRatios = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'A', _1: 13},
			{ctor: '_Tuple2', _0: 'B', _1: 3},
			{ctor: '_Tuple2', _0: 'C', _1: 3},
			{ctor: '_Tuple2', _0: 'D', _1: 6},
			{ctor: '_Tuple2', _0: 'E', _1: 18},
			{ctor: '_Tuple2', _0: 'F', _1: 3},
			{ctor: '_Tuple2', _0: 'G', _1: 4},
			{ctor: '_Tuple2', _0: 'H', _1: 3},
			{ctor: '_Tuple2', _0: 'I', _1: 12},
			{ctor: '_Tuple2', _0: 'J', _1: 2},
			{ctor: '_Tuple2', _0: 'K', _1: 2},
			{ctor: '_Tuple2', _0: 'L', _1: 5},
			{ctor: '_Tuple2', _0: 'M', _1: 3},
			{ctor: '_Tuple2', _0: 'N', _1: 8},
			{ctor: '_Tuple2', _0: 'O', _1: 11},
			{ctor: '_Tuple2', _0: 'P', _1: 3},
			{ctor: '_Tuple2', _0: 'Q', _1: 2},
			{ctor: '_Tuple2', _0: 'R', _1: 9},
			{ctor: '_Tuple2', _0: 'S', _1: 6},
			{ctor: '_Tuple2', _0: 'T', _1: 9},
			{ctor: '_Tuple2', _0: 'U', _1: 6},
			{ctor: '_Tuple2', _0: 'V', _1: 3},
			{ctor: '_Tuple2', _0: 'W', _1: 3},
			{ctor: '_Tuple2', _0: 'X', _1: 2},
			{ctor: '_Tuple2', _0: 'Y', _1: 3},
			{ctor: '_Tuple2', _0: 'Z', _1: 2}
		]));
var _user$project$Main$repeatedLetterList = function (letter) {
	var letterCount = A2(
		_elm_lang$core$Dict$get,
		_elm_lang$core$String$toUpper(letter),
		_user$project$Main$letterRatios);
	var repeatedLetterString = function () {
		var _p1 = letterCount;
		if (_p1.ctor === 'Just') {
			return A2(_elm_lang$core$String$repeat, _p1._0, letter);
		} else {
			return '';
		}
	}();
...
var _user$project$Main$shuffleTiles = function (tiles) {
	var randomListGenerator = A2(
		...
		_user$project$Main$numberOfTiles,
		A2(_elm_lang$core$Random$int, 1, _user$project$Main$numberOfTiles));
	var indexes = _elm_lang$core$Basics$fst(
		A2(
			_elm_lang$core$Random$step,
			randomListGenerator,
			_elm_lang$core$Random$initialSeed(432750601478)));
	var indexedList = A3(
		_elm_lang$core$List$map2,
		F2(
			function (v0, v1) {
	...
	return _elm_lang$core$Basics$snd(
		_elm_lang$core$List$unzip(
			A2(_elm_lang$core$List$sortBy, _elm_lang$core$Basics$fst, indexedList)));
};
var _user$project$Main$Player = F4(
	function (a, b, c, d) {
		return {id: a, name: b, tiles: c, board: d};
	});
var _user$project$Main$generatePlayers = F2(
	function (playerNames, tiles) {
		var n = _elm_lang$core$List$length(playerNames);
		var ids = A2(
			_elm_lang$core$List$map,
			function (num) {
				return num + 1;
...
var _user$project$Main$TradeLetter = function (a) {
	return {ctor: 'TradeLetter', _0: a};
};
var _user$project$Main$TakeLetter = function (a) {
	return {ctor: 'TakeLetter', _0: a};
};
var _user$project$Main$PlayLetter = function (a) {
	return {ctor: 'PlayLetter', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4000/socket/play_letter', _user$project$Main$PlayLetter),
				A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4000/socket/take_letter', _user$project$Main$TakeLetter),
				A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4000/socket/trade_letter', _user$project$Main$TradeLetter),
				A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:4000/socket/game_over', _user$project$Main$GameOver)
			]));
};
